...
<div>
    <ul>
        <h1>Search for your products details below</h1>
        <li ng-repeat="item in items | filter:globalSearch">
            {{"Name: " + item.Name +" Description: " + item.Description + "Price: " + item.Price + "Image: " +item.<img ng-src="{{myVar}}">}}
        </li>
    </ul>
</div>
...
<div id="searchBoxes">
    ...
    Item Name Search Filter: <input type="text" ng-model="globalSearch.Name"><br><br>
    ...
    Image Search Filter: <input type="img" ng-model="globalSearch.<img>"><br><br>
</div>
</body>
<!-- Footer -->
<footer class="py-5 bg-dark">
    <div class="container">
        <p class="m-0 text-center text-white">Copyright &copy; {{Cart}} {{copyright}}.</p>
    </div>
</footer>
